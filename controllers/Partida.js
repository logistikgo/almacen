    ...
    try {
        ...
        let partidas = await Partida
            ...
            .populate({
                path: "entrada_id",
                model: "Entrada",
                select: 'fechaEntrada stringFolio folio referencia embarque item proveedor ordenCompra factura tracto remolque transportista fechaAlta'
            })
            .populate({
                path: 'salidas_id.salida_id',
                model: 'Salida',
            ...
            partidas.forEach(partida => 
            {
                ...
                if(partida.entrada_id != undefined && resFecha==true && resClasificacion==true && resSubclasificacion ==true && resClave==true && (partida.tipo=="NORMAL" || partida.tipo=="AGREGADA" || partida.tipo=="MODIFICADA"))
                {   
