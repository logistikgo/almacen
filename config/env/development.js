let uriDb = process.env.DB_URL_ACCESS_DEV;

module.exports = {
    port: process.env.PORT || 8080,
	currentEnv: process.env.NODE_ENV,
	mongoDb: {
		user: process.env.DB_USER_MONGO_DEV,
		password: process.env.DB_PASSWORD_MONGO_DEV,
		dbName: process.env.DB_DB_NAME_MONGO_DEV,
		createUri: function () {
